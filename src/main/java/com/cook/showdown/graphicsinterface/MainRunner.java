...
import com.cook.showdown.gamedata.GameManager;
...
import com.cook.showdown.players.PlayerComparator;
...
public class MainRunner {
	...
	public static void main(String[] args) throws IOException, FileNotFoundException {
		...
		DraftManager mainPool = DraftManager.initializePool(new File("DataFiles/2003 pitchers.txt"),
				new File("DataFiles/2005 hitters.txt"));
